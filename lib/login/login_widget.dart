                        ...
                        if (_model.tabBarCurrentIndex == 1)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.apiResultuf8 =
                                  await InspirationQuoteCall.call();

                              if ((_model.apiResultuf89?.succeeded ?? true)) {
                                FFAppState().Quote = valueOrDefault<String>(
                                  InspirationQuoteCall.quote(
                                    (_model.apiResultuf89?.jsonBody ?? ''),
                                  ),
                                  'q',
                                );
                                safeSetState(() {});
